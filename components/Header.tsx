...
<nav className="nav">
<Link className="route active" data-view="home" href="/">{"Home"}</Link>
...
<Link className="search-btn route" data-view="stores" href="/stores/">{"Search stores"}</Link>
<Link className="visit-btn route" data-view="visit" href="/visit/">Plan a visit <SiteIcon name="external" className="inline-icon" /></Link>
<button className="menu" aria-label="Menu"><span ></span><span ></span></button>
</div>
</header>);}
